...
<section id="home">
    ...
    <header class="section-title">Recently added movies</header>
    ...
    <footer class="section-title">
        <p>Browse all movies in the <a href="/catalog">Movie Catalog</a></p>
    </footer>
</section>`;
...
<a class="card" href=${`/details/${recipe._id}`} >
    <article class="recent">
        ...
        <div class="recent-title">${recipe.title}</div>
    </article>
</a>`;
